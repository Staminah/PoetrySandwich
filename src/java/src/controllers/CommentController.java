...
public class CommentController implements Serializable {
    ...
    public String prepareList() {
        recreateModel();
        return "/faces/myAdmin/comment/List.xhtml";
    }

    public String prepareView() {
        current = (Comment) getItems().getRowData();
        selectedItemIndex = pagination.getPageFirstItem() + getItems().getRowIndex();
        return "/faces/myAdmin/comment/View.xhtml";
    }

    public String prepareCreate() {
        current = new Comment();
        selectedItemIndex = -1;
        return "/faces/myAdmin/comment/Create.xhtml";
    }
    ...
    public String prepareEdit() {
        current = (Comment) getItems().getRowData();
        selectedItemIndex = pagination.getPageFirstItem() + getItems().getRowIndex();
        return "/faces/myAdmin/comment/Edit.xhtml";
    }
    ...
    public String previous() {
        ...
        recreateModel();
        return "/faces/myAdmin/commentList.xhtml";
    }
